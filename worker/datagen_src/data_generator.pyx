...
cdef def node_spec(_type: str, address: str, config: Dict[str, Any], inputs: Dict[str, List[str]], outputs: Dict[str, List[str]], name: str = None) -> Dict[str, Any]:
    spec = {
        '_type': _type,
        'address': address,
        'config': config,
